...
class WhatICouldExpectSection extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    return Section(
      ...
      children: [
        div(
          classes: 'expectations-journey mx-auto max-w-7xl px-6 py-20 md:py-28',
          [
            div(
              classes: 'expectations-intro max-w-3xl',
              [
                h2(
            ...
            div(
              classes: 'expectations-viewport mt-12',
              [
                ul(
                  classes: 'expectations-track border-y border-text-inverse/20',
                  [
                    li(
                      classes:
                          'expectation-step grid gap-3 border-b border-text-inverse/20 py-6 '
                    ...
                    li(
                      classes:
                          'expectation-step grid gap-3 py-6 md:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] '
                          'md:gap-10',
                      [
                        h3(
                          classes: 'font-headline text-2xl font-semibold tracking-tight text-chartreuse',
